...
class DateNormalizationForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if date_tag.line_text:  # New explicit field from parser v0.0.22+
            ...
            # Generate URLs
            document_url = reverse('twf:view_document', args=[date_tag.page.document.pk])
            transkribus_url = date_tag.get_transkribus_url()
            document_title = date_tag.page.document.title or date_tag.page.document.document_id
            ...
            <div class="mt-3 p-2 bg-light border rounded">
                ...
                <p class="small text-muted mb-0 mt-1">
                    ...
                    | <i class="fa fa-book me-1"></i><a href="{document_url}" class="text-decoration-none">{document_title}</a>
                    | <a href="{transkribus_url}" target="_blank" class="text-decoration-none" title="Open in Transkribus"><i class="fa fa-external-link me-1"></i>Transkribus</a>
                </p>
            </div>"""
